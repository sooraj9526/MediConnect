...
# Keep the secret key outside GitHub.
# If MEDICONNECT_SECRET_KEY is not set, this development
# key will be used locally.
SECRET_KEY = os.environ.get(
    'MEDICONNECT_SECRET_KEY',
...
# During development, emails are printed in the terminal
